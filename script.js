...
function addTransaction(e){
    ...
    if(text.value.trim() === '' || amount.value.trim() === ''){
        error.innerHTML = "กรุณากรอกข้อมูลให้ครบถ้วน"
    }else{
        const data={
            id:autoID(),
            text:text.value,
...
function updateList(){
    allFilter = document.querySelectorAll('.box')
    return console.log(allFilter)
}

const allFilterbtns = document.querySelectorAll(".listbtn")
